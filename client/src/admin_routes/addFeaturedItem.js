...
const AddFeatureItem = () => {
  ...
  const handleUpload = () => {
    ...
    formData.append("featured_product_name", productN);
    formData.append("featured_product_price", productP);
   

    Axios.post("http://localhost:3001/upfeaturedItem", formData)
      .then((response) => {
  ...
  return (
    ...
    <>
      ...
      <div className="count-card col-lg-4 mt-5 pt-5 pb-5 d-flex align-items-center justify-content-center">
          <h1 className="orders-txt text-center">ADD FEATURED ITEM</h1>
      </div>
